 ...
 */
export const Modal: React.FC<TextareaProps> = ({ modalHeading, modalLabel, open, setIsOpen, children }) => {
    return (
        <>
            {open &&
                <div className="fixed z-10 inset-0" role="dialog" aria-modal="true">
                    <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        {/* Background overlay */}
                        <div className="fixed inset-0 bg-modal-bg-blue bg-opacity-50 transition-opacity" aria-hidden="true" onClick={() => setIsOpen(false)} />
